...
//if($kd=="LC"){
     include "koneksi.php";
     $no = mysqli_query($koneksi,"SELECT no_form FROM alat_tokebi WHERE no_form like '%AT%' ORDER BY id DESC");
     ...
     if ($urut2!==$thn){
        $format = "AT-" .$bln."-".$thn."-"."0001";
     }else{
         if (strlen($tambah) == 1){
           $format = "AT-".$bln."-".$thn."-"."000".$tambah;
         }else if (strlen($tambah) == 2) {
           $format = "AT-".$bln."-".$thn."-"."00".$tambah;
         }else if (strlen($tambah) == 3) {
           $format = "AT-".$bln."-".$thn."-"."0".$tambah;
         }
         else{
           $format = "AT-".$bln."-".$thn."-".$tambah;
         }
     };
    //}
                    ...
                    <div class="row">
                        ...
                        <div class="box-body table-responsive">
                                ...
                                <table id="example1" border="1" class=" table-hover" style="font-size: 70%; margin-top: -3%">
                                        ...
                                        <h1 style="color: white"><center><b>LOGBOOK PENGGUNAAN ALAT TOKEBI</b></center></h1>
                             ...
                             if($_SESSION["level"] == "admin"){
                                ...
                                echo "
                                    <a href='edit_data_at.php?kode=$tampil->no_form'><input type='button' class='btn-update'></a>
                                ...
                                <?php
                                if (isset($_GET['kode'])){
                                    mysqli_query($koneksi,"delete from alat_tokebi where no_form='$_GET[kode]'");

                                    echo "<script>alert('Data baru telah dihapus');window.location='data_alat_tokebi.php';</script>";
