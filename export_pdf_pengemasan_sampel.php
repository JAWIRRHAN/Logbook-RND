...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
        ...
        <form method="get" action="pengemasan_sampel_pdf.php">
        <table border="1" width="100%">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="form-group">
                        ...
                        <tr>
                            <td colspan="3" width="50%"><center>Export PDF Logbook Pengemasan Sampel Sesuai Periode</center></td>
                          ...
                          <td width="15%"><input type="date" name="tgl_awal" value="<?= @$_GET['tgl_awal'] ?>" class="form-control tgl_awal" placeholder="Tanggal Awal"></td>
                            ...
                            <td><a class="form-control btn btn-success" href="excel_pengemasan_sampel.php" ><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</td>
                          </tr>
                        </div>
            ...
            <!-- <button type="submit" name="cetaks" value="true" class="btn btn">TAMPILKAN</button> -->
            <?php
                    ...
                    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                        while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
                            $tgl = date('d-m-Y', strtotime($tampil['tgl_relese'])); // Ubah format tanggal jadi dd-mm-yyyy
                                ...
                                // echo "<td align='center'>".$tampil["week"]."</td>";
                                // echo "<td align='center'>".$tampil["terima"]."</td>";
                                // echo "<td align='justify'>".$tampil["oleh"]."</td>";
                                // echo "<td align='center'>".$tampil["remar"]."</td>";
