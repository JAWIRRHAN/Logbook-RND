...
<html>
<head>
  <title>R.RND.035-00 Logbook Penggunaan Alat Homogenizer PDF</title>
  <style>
     table {
...
<?php
  ...
  if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
    ...
    $query = "SELECT * FROM homogen";
    $label = "Semua Data Logbook Penggunaan Alat Homogenizer";
    $nama_alat = "Nomor Alat : ";
  }else{ // Jika terisi
    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
    $query = "SELECT * FROM homogen WHERE (tgl BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGGUNAAN ALAT HOMOGENIZER</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGGUNAAN ALAT HOMOGENIZER</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.035-00</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
...
<?php echo $label ?>
  ...
  <tr style="background-color: darkblue;">
        ...
        <th align="center" style="color: white;" width="50">Tanggal Input</th>
    ...
    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
      while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
        ...
        echo "<tr>";
                                ...
                                echo "<td align='center'>".$tampil["urai_pggn"]."</td>";
                                echo "<td align='center'>".$tampil["kondisi"]."</td>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGGUNAAN ALAT HOMOGENIZER.pdf', 'I');
?>