                    ...
                    <div class="row">
                        ...
                        <div class="box-body table-responsive">
                                ...
                                <table id="example1" border="1" class=" table-hover" style="font-size: 70%; margin-top: -3%">
                                        ...
                                        <tr>
                                                ...
                                                <th colspan="9">
                                                            ...
                                                            <center><h2><b>
                                                            LOGBOOK PENGGUNAAN ALAT BLENDER
                             ...
                             if($_SESSION["level"] == "admin"){
                                ...
                                echo "
                                    <a href='edit_data_ab.php?kode=$tampil->no_form'><input type='button' class='btn-update'></a>
                                ...
                                <?php
                                if (isset($_GET['kode'])){
                                    mysqli_query($koneksi,"delete from alat_blender where no_form='$_GET[kode]'");

                                    echo "<script>alert('Data baru telah dihapus');window.location='data_alat_blender.php';</script>";
