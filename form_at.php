...
<form action="barang_tambah_alat_tokebi.php" method="post">
...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  <table class="table" border="1" width="100%">
                ...
                <tr>
                    ...
                    <td rowspan="2"><center><h3><b>LOGBOOK PENGGUNAAN<br>ALAT TOKEBI</b></h3></center></td>
                    <td><b>NOMOR FORMULIR</b></td>
                    <td><b>FR.RND.050-00</b></td>
                </tr>   
  ...
  <table border="1" width="100%">
    ...
    <tr>
        ...
        <td> <input type="text" class="form-control" name="ur_pgn" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Kondisi Alat </td>
        <td> <select class="form-control" name="knds_alt" required>
