                    ...
                    <div class="row">
                        ...
                        <table id="example1" border="1" class=" table-hover" style="font-size: 70%; margin-top: -3%">
                                       ...
                                       <tr>
                                                ...
                                                <center><h2><b>
                                                LOGBOOK PENGGUNAAN ALAT OVERHEAD STIRRER
                             ...
                             if($_SESSION["level"] == "admin"){
                                ...
                                echo "
                                    <a href='edit_data_os.php?kode=$tampil->no_form'><input type='button' class='btn-update'></a>
                                ...
                                if (isset($_GET['kode'])){
                                    ...
                                    echo "<script>alert('Data baru telah dihapus');window.location='data_overhead.php';</script>";
