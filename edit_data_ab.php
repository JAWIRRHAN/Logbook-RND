...
include "koneksi.php";
$sql=mysqli_query($koneksi,"select * from alat_blender where no_form='$_GET[kode]'");
...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  ...
  <table border="1" width="100%">
    ...
    <tr>
        ...
        <td> <input type="text" class="form-control" name="produk" value="<?php echo $data['produk']; ?>" required> </td>
    </tr>
    <tr>
...
<br>
  ...
  <div width=15% class="text-left">
                    <a href="data_alat_blender.php"><button type="button" class="btn btn-primary"><i class="fa fa-reply" aria-hidden="true"></i> Back</button></a>
...
<?php
                ...
                if(isset($_POST['proses'])){
                    mysqli_query($koneksi,"update alat_blender set
                            tgl = '$_POST[tgl]',
                            produk = '$_POST[produk]',
                    ...
                    echo "<script>alert('Data baru telah dirubah');window.location='data_alat_blender.php';</script>";
