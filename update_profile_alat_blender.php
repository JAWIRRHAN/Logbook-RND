...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($koneksi, "UPDATE `users` SET name = '$update_name', user_name = '$update_uname' WHERE id = '$uname'") or die('query failed');
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         mysqli_query($koneksi, "UPDATE `users` SET password = '$confirm_pass' WHERE id = '$uname'") or die('query failed');
...
<div class="update-profile">
   ...
   <?php
      ...
      <a href="profile_alat_blender.php" class="delete-btn">go back</a>
   </form>
