...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  <table class="table" border="1" width="100%">
                ...
                <tr>
                    ...
                    <td rowspan="2"><center><h3><b>LOGBOOK<br>PEMINJAMAN RETAIN R&D DEPARTEMENT</b></h3></center></td>
  ...
  <table border="1" width="100%">
    ...
    <input type="hidden" class="form-control"  name="no_form"  value="<?php echo $format?>" required> 
    ...
    <tr>
        ...
        <td> <input type="text" class="form-control" name="jns_smpl" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Kode Sampel / Tanggal Sampel </td>
        <td> <input type="date" class="form-control" name="tgl_smpl" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Nama Peminjam Sampel  </td>
        <td> <input type="text" class="form-control" name="nm_pmnjm" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Tanggal Meminjam </td>
        <td> <input type="date" class="form-control"  name="tgl_mnjm" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Tanggal Pengembalian  </td>
        <td><input type="date" class="form-control"  name="tgl_pgmln" required> </td>
    </tr>
    </table>
    </center>
