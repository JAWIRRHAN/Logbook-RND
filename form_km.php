...
<form action="barang_tambah_kamera.php" method="post">
...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  ...
  <table border="1" width="100%">
    ...
    <tr>
        <td class="bg-light" style="width: 30%"> Tanggal Pengguaaan </td>
        <td> <input type="date" class="form-control"  name="tgl_pgn" required> </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td > Mulai : <input type="time" class="form-control" name="wkt_pgn_mulai" required> </td>
       
    </tr>
    <tr>
    <td > Selesai : <input type="time" class="form-control" name="wkt_pgn_selesai" required> </td>
       
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Total Waktu Penggunann </td>
        <td> <input type="time" class="form-control" name="ttl_pgn" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%"> Nama Pengguna </td>
        <td> <input type="text" class="form-control" name="tgn" required> </td>
    </tr>
...
<tr>
  <td>
  <textarea name="ctn_rm" style="width: 100%" placeholder="Remarks"  required></textarea>
  </td>
</tr>
