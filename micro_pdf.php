...
<html>
<head>
  <title>FR.RND.037-00. Logbook Serah Terima Sampel Micro Stabtest PDF</title>
  <style>
    table {
...
<body>
  ...
  if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
    ...
    $label = "Semua Data Logbook Penyerahan Sampel Micro Stabtest";
  }else{ // Jika terisi
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENYERAHAN SAMPEL MICRO STABTEST</center></h1></td>
  </tr>
  <tr>
...
<br><br><br><br>
  ...
  <tr style="background-color: darkblue;">
        ...
        <th align="center" style="color: white;" width="200">Nama Konsumen/Merek</th>
