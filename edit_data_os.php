...
include "koneksi.php";
$sql=mysqli_query($koneksi,"select * from alat where no_form='$_GET[kode]'");
...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  <table class="table" border="1" width="100%">
                ...
                <tr>
                    ...
                    <td rowspan="2"><center><h3><b>LOGBOOK PENGGUNAAN ALAT<br>OVERHEAD STIRRER</b></h3></center></td>
  ...
  <table border="1" width="100%">
    ...
    <tr>
        ...
        <td> <input type="text" class="form-control" name="urai_pggn" value="<?php echo $data['urai_pggn']; ?>" required> </td>
    </tr>
    <tr>
...
<br>
  ...
  <div width=15% class="text-left">
                    <a href="data_overhead.php"><button type="button" class="btn btn-primary"><i class="fa fa-reply" aria-hidden="true"></i> Back</button></a>
...
<?php
                ...
                if(isset($_POST['proses'])){
                    ...
                    echo "<script>alert('Data baru telah dirubah');window.location='data_overhead.php';</script>";
