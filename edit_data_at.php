...
include "koneksi.php";
$sql=mysqli_query($koneksi,"select * from alat_tokebi where no_form='$_GET[kode]'");
...
<br>
  ...
  <div width=15% class="text-left">
                    <a href="data_alat_tokebi.php"><button type="button" class="btn btn-primary"><i class="fa fa-reply" aria-hidden="true"></i> Back</button></a>
...
<?php
                ...
                if(isset($_POST['proses'])){
                    mysqli_query($koneksi,"update alat_tokebi set
                            tgl = '$_POST[tgl]',
                            ur_pgn = '$_POST[ur_pgn]',
                    ...
                    echo "<script>alert('Data baru telah dirubah');window.location='data_alat_tokebi.php';</script>";
