...
<html>
<head>
<title>FR.RND.031-00 Logbook Penggunaan Alat Hot Plate PDF</title>
  <style>
     table {
...
<?php
  ...
  if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
    ...
    $query = "SELECT * FROM hotplate";
    $label = "Semua Data Penggunaan Alat Hot Plate";
    $nama_alat = "Nomor Alat : ";
  }else{ // Jika terisi
    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
    $query = "SELECT * FROM hotplate WHERE (tgl BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGGUNAAN ALAT HOT PLATE</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGGUNAAN ALAT HOT PLATE</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.031-00</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGGUNAAN ALAT HOT PLATE.pdf', 'I');
?>