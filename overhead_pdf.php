...
<html>
<head>
  <title>FR.RND.034-00 LOGBOOK PENGGUNAAN ALAT OVERHEAD STIRRER PDF</title>
  <style>
    table {
...
<?php
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGGUNAAN ALAT OVERHEAD STIRRER</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGGUNAAN ALAT OVERHEAD STIRRER</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.034-00</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
...
<?php echo $label ?>
  ...
  <tr style="background-color: darkblue;">
        ...
        <th align="center" style="color: white;" width="200">Uraian Penggunaan</th>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGGUNAAN ALAT OVERHEAD STIRRER.pdf', 'I');
?>