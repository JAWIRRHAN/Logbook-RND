...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
        ...
        <form method="get" action="retain_pdf.php">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="form-group">
                        ...
                        <!-- <div class="input-group"> -->
                          ...
                          <!-- <tr>
                            <td width="28%">Pilih Logbook</td>
                            <td colspan="6">
                              <select class="form-control">Pilih Logbook
                              <option>Pilih</option>
                              <a href="micro_pdf.php"><option>LOGBOOK PENYERAHAN SAMPEL MICRO STABTEST</option></a>
                              <option>LOGBOOK PENYERAHAN SAMPEL MICRO STABTEST</option>
                              <option>LOGBOOK PENYERAHAN SAMPEL MICRO STABTEST</option>
                              </select>
                            </td>
                          </tr> -->
                          <tr>
                            <td colspan="3" width="50%"><center>Export PDF Logbook Peminjaman Retian R&D Departement Sesuai Periode</center></td>
                          ...
                          <td width="15%"><input type="date" name="tgl_awal" value="<?= @$_GET['tgl_awal'] ?>" class="form-control tgl_awal" placeholder="Tanggal Awal"></td>
                            ...
                            <td><a class="form-control btn btn-success" href="excel_retain.php" ><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</td>
                          </tr>
                        </div>
        ...
        if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
            ...
            $url_cetak = "retain_pdf.php";
            $label = "Semua Data Logbook Peminjaman Retain";
        }else{ // Jika terisi
            // Buat query untuk menampilkan data transaksi sesuai periode tanggal
            $query = "SELECT * FROM peminjaman WHERE (tgl_smpl BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
            $url_cetak = "retain_pdf.php?tgl_awal=".$tgl_awal."&tgl_akhir=".$tgl_akhir."&cetak=true";
