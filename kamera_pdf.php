...
<html>
<head>
<title>FR.RND.044-00 Logbook Penggunaan Kamera R&D PDF</title>
  <style>
     table {
...
<?php
  ...
  if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
    ...
    $label = "Semua Data Penggunaan Kamera R&D";
  }else{ // Jika terisi
    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
    $query = "SELECT * FROM kamera WHERE (tgl_pgn BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGGUNAAN KAMERA R&D</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGGUNAAN KAMERA R&D</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.044-00</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
...
<?php echo $label ?>
  ...
  <tr style="background-color: darkblue;">
                  <th align="center" style="color: white;" rowspan="2" width="50"><center>No</center></th>
                  <th align="center" style="color: white;" rowspan="2" ><center>Tanggal Input</center></th>
                  <th align="center" style="color: white;" rowspan="2" width="150"><center>No Form</center></th>
                  <th align="center" style="color: white;" rowspan="2" ><center>Tanggal Penggunaan</center></th>
                  <th align="center" style="color: white;" rowspan="2" ><center>Nama Staff</center></th>
                  <th align="center" style="color: white;" colspan="2" width="200px"><center>Waktu Penggunaan</center></th>
                  <th align="center" style="color: white;" rowspan="2" ><center>Total Penggunaan</center></th>
                  <th align="center" style="color: white;" rowspan="2" ><center>Nama Pengguna</center></th>
                  <th align="center" style="color: white;" rowspan="2" ><center>Dibuat Oleh</center></th>
                  <th align="center" style="color: white;" rowspan="2" width="200px"><center>Remarks</center></th>
    ...
    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
      while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
        $tgl = date('d-m-Y', strtotime($tampil['tgl_pgn'])); // Ubah format tanggal jadi dd-mm-yyyy
        echo "<tr>";
                                echo "<td align='center'>".$i++."</td>";
                                echo "<td align='center'>". $tampil["tgl_input"] ."</td>";
                                echo "<td align='center'>".$tampil["no_form"]."</td>";
                                echo "<td align='center'>".$tampil["tgl_pgn"]."</td>";
                                echo "<td align='center'>".$tampil["nm"]."</td>";
                                echo "<td align='center'>".$tampil["wkt_pgn_mulai"]."</td>";
                                echo "<td align='center'>".$tampil["wkt_pgn_selesai"]."</td>";
                                echo "<td align='center'>".$tampil["tgn"]."</td>";
                                echo "<td align='center'>".$tampil["tgn"]."</td>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGGUNAAN KAMERA R&D.pdf', 'I');
?>