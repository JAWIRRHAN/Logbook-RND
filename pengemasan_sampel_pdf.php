...
<html>
<head>
  <title>FR.RND.021-02 Logbook Pengemasan Sampel PDF</title>
  <style>
    table {
...
<body>
        ...
        $query = "SELECT * FROM pengemesan_sampel";
        $url_cetak = "pengemasan_sampel_pdf.php";
        $label = "Semua Data Logbook Pengemasan Sampel";
        }else{ // Jika terisi
        // Buat query untuk menampilkan data transaksi sesuai periode tanggal
        $query = "SELECT * FROM pengemesan_sampel WHERE (tgl_relese BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
        $url_cetak = "pengemasan_sampel_pdf.php?tgl_awal=".$tgl_awal."&tgl_akhir=".$tgl_akhir."&cetak=true";
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGEMASAN SAMPEL</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGEMASAN SAMPEL</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.021-02</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
  ...
  <tr style="background-color: darkblue;">
        ...
        <th align="center" style="color: white;" width="100">Tanggal Release</th>
        <th align="center" style="color: white;" width="100">Tanggal Pengemasan</th>
        <th align="center" style="color: white;" width="100">Nama Verifikasi Sampel</th>
    ...
    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
      while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
        $tgl = date('d-m-Y', strtotime($tampil['tgl_relese'])); // Ubah format tanggal jadi dd-mm-yyyy
        echo "<tr>";
        ...
        echo "<td align='center'>".$tampil["tgl_relese"]."</td>";
        echo "<td align='center'>".$tampil["tgl_pggmn"]."</td>";
        echo "<td align='center'>".$tampil["nm_verifi"]."</td>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGEMASAN SAMPEL.pdf', 'I');
?>