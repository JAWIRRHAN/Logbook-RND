...
include "koneksi.php";
$sql=mysqli_query($koneksi,"select * from pengemesan_sampel where no_form='$_GET[kode]'");
...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  ...
  <tr>
    ...
    <tr>
        <td class="bg-light" width="30%">Nama Produk</td>
        <td> <input type="date" class="form-control" name="tgl_relese" value="<?php echo $data['tgl_relese']; ?>" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%">Tanggal Fix</td>
        <td> <input type="date" class="form-control" name="tgl_pggmn" value="<?php echo $data['tgl_pggmn']; ?>" required> </td>
    </tr>
    <tr>
        <td class="bg-light" width="30%">Jumlah</td>
        <td> <input type="text" class="form-control"  name="nm_verifi" value="<?php echo $data['nm_verifi']; ?>" required> </td>
    </tr>
    </table>
...
<br>
  ...
  <div width=15% class="text-left">
                    <a href="data_ps.php"><button type="button" class="btn btn-primary"><i class="fa fa-reply" aria-hidden="true"></i> Back</button></a>
...
<?php
                ...
                if(isset($_POST['proses'])){
                    mysqli_query($koneksi,"update pengemesan_sampel set
                    ...
                    echo "<script>alert('Data baru telah dirubah');window.location='data_ps.php';</script>";
