...
<html>
<head>
<title>FR.RND.069-00 . LOGBOOK PENGGUNAAN ALAT BLENDER PDF</title>
  <style>
     table {
...
<?php
  ...
  if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
    ...
    $query = "SELECT * FROM alat_blender";
    $label = "Semua Data Penggunaan Alat Blender";
    $nama_alat = "Nomor Alat : ";
  }else{ // Jika terisi
    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
    $query = "SELECT * FROM alat_blender WHERE (tgl BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGGUNAAN ALAT BLENDER</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGGUNAAN ALAT BLENDER</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.069-00</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
...
<?php echo $label ?>
  ...
  <tr style="background-color: darkblue;">
        ...
        <th align="center" style="color: white;" width="100">Produk</th>
    ...
    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
      while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
        ...
        echo "<tr>";
                                ...
                                echo "<td align='center'>".$tampil["produk"]."</td>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGGUNAAN ALAT BLENDER.pdf', 'I');
?>