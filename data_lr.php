                    ...
                    <div class="row">
                        ...
                        <div class="box-body table-responsive">
                                ...
                                <table id="example1" border="1" class=" table-hover" style="font-size: 70%; margin-top: -3%">
                                        ...
                                        <h1 style="color: white"><center><b>LOGBOOK LIST DATA RETAIN</b></center></h1>
                                            ...
                                            <tr>
                                                ...
                                                <th><center>Tanggal Fix</center></th>
                             ...
                             if($_SESSION["level"] == "admin"){
                                ...
                                echo "
                                    <a href='edit_data_lr.php?kode=$tampil->no_form'><input type='button' class='btn-update'></a>
                                ...
                                <?php
                                if (isset($_GET['kode'])){
                                    mysqli_query($koneksi,"delete from form_list where no_form='$_GET[kode]'");

                                    echo "<script>alert('Data baru telah dihapus');window.location='data_lr.php';</script>";
