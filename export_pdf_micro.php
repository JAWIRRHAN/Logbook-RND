...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
        ...
        <form method="get" action="micro_pdf.php">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="form-group">
                        ...
                        <tr>
                            <td colspan="3" width="50%"><center>Export PDF Logbook Laporan Data Penyerahan Sampel Micro Stabtest Sesuai Periode</center></td>
                          ...
                          <td width="15%"><input type="date" name="tgl_awal" value="<?= @$_GET['tgl_awal'] ?>" class="form-control tgl_awal" placeholder="Tanggal Awal"></td>
                            ...
                            <td><a class="form-control btn btn-success" href="excel_micro.php" ><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</td>
                          </tr>
                        </div>
        ...
        if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
            ...
            $url_cetak = "micro_pdf.php";
            $label = "Semua Data Konsumen";
        }else{ // Jika terisi
            // Buat query untuk menampilkan data transaksi sesuai periode tanggal
            $query = "SELECT * FROM konsumen WHERE (tgl BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
            $url_cetak = "micro_pdf.php?tgl_awal=".$tgl_awal."&tgl_akhir=".$tgl_akhir."&cetak=true";
