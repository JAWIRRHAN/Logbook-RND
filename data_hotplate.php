...
//if($kd=="LC"){
     include "koneksi.php";
     $no = mysqli_query($koneksi,"SELECT no_form FROM hotplate WHERE no_form like '%HP%' ORDER BY id DESC");
     ...
     if ($urut2!==$thn){
        $format = "HP-" .$bln."-".$thn."-"."0001";
     }else{
         if (strlen($tambah) == 1){
           $format = "HP-".$bln."-".$thn."-"."000".$tambah;
         }else if (strlen($tambah) == 2) {
           $format = "HP-".$bln."-".$thn."-"."00".$tambah;
         }else if (strlen($tambah) == 3) {
           $format = "HP-".$bln."-".$thn."-"."0".$tambah;
         }
         else{
           $format = "HP-".$bln."-".$thn."-".$tambah;
         }
     };
    //}
                    ...
                    <div class="row">
                        ...
                        <div class="box-body table-responsive">
                                ...
                                <table id="example1" border="1" class=" table-hover" style="font-size: 70%; margin-top: -3%">
                                        ...
                                        <tr>
                                                    ...
                                                    <th colspan="9">
                                                                ...
                                                                <center><h2><b>
                                                                LOGBOOK PENGGUNAAN ALAT HOT PLATE
                             ...
                             if($_SESSION["level"] == "admin"){
                                ...
                                echo "
                                    <a href='edit_data_hp.php?kode=$tampil->no_form'><input type='button' class='btn-update'></a>
                                ...
                                <?php
                                if (isset($_GET['kode'])){
                                    mysqli_query($koneksi,"delete from hotplate where no_form='$_GET[kode]'");

                                    echo "<script>alert('Data baru telah dihapus');window.location='data_hotplate.php';</script>";
