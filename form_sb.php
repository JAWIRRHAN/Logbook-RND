...
<form action="barang_tambah_serah_terima.php" method="post">
...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
  ...
  <table border="1" width="100%">
    ...
    <tr>
                    ...
                    <td><input type="text" class="form-control" name="nm_pro" required></td>
            </tr>
        <tr>
                    <td class="bg-light" width="28%">Skala</td>
                    <td><input type="text" class="form-control" name="skl" required></td>
            </tr>
            <tr>
                    <td class="bg-light" width="28%">Jenis Sediaan</td>
                    <td> <input type="text" class="form-control" name="jns_sedia" required></td>
            </tr>
            <tr>
            ...
            <tr>
                    ...
                    <td> <input type="text" class="form-control" name="serah_nm" required></td>
            </tr>
            <tr>
                    <td class="bg-light" width="28%">Diterima Oleh Nama</td>
                    <td> <input type="text" class="form-control" name="tm_nm" required></td>
            </tr>
