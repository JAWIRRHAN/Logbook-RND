...
<div class="container modal-lg p-3 border" style="width:60%; margin-left:27%">
        ...
        <form method="get" action="list_data_retain_pdf.php">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="form-group">
                        ...
                        <tr>
                            <td colspan="3" width="50%"><center>Export PDF Logbook List Data Retain Sesuai Periode</center></td>
                          ...
                          <td width="15%"><input type="date" name="tgl_awal" value="<?= @$_GET['tgl_awal'] ?>" class="form-control tgl_awal" placeholder="Tanggal Awal"></td>
                            ...
                            <td><a class="form-control btn btn-success" href="excel_list_data_retain.php" ><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</td>
                          </tr>
                        </div>
        ...
        if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
            ...
            $url_cetak = "list_data_retain_pdf.php";
        ...
        <div class="table-responsive" style="margin-top: 10px;">
            <table border="1" >
                ...
                <tbody> -->
                    ...
                    include "koneksi.php";
                    $i=1;
                    $ambildata = mysqli_query($koneksi,"select * from form_list WHERE no_form LIKE '%D
                    LR%' ORDER by id DESC");
                    ...
                    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                        while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
                            $tgl_fix = date('d-m-Y', strtotime($tampil['tgl_fix'])); // Ubah format tanggal jadi dd-mm-yyyy
                                // echo "<tr>";
