...
<html>
<head>
<title>FR.RND.050-00 Logbook Penggunaan Alat Tokebi PDF</title>
  <style>
     table {
...
<?php
  ...
  if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
    ...
    $query = "SELECT * FROM alat_tokebi";
    $label = "Semua Data Penggunaan Alat Tokebi";
    $nama_alat = "Nomor Alat : ";
  }else{ // Jika terisi
    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
    $query = "SELECT * FROM alat_tokebi WHERE (tgl BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
  ...
  <tr>
    <td width="100px" style="background-color: darkblue; color:white; padding: 90px;" colspan="2"><h1><center>LOGBOOK PENGGUNAAN ALAT TOKEBI</center></h1></td>
  </tr>
  <tr>
...
<p align="left"><u>LOGBOOK PENGGUNAAN ALAT TOKEBI</u></p>
<br><br><br><br>
<p align="left">Nomor Logbook : FR.RND.050-00</p>
<br><br><br><br>
  <table border="1" width="100%">
                  <tr>
...
<?php echo $label ?>
  ...
  <tr style="background-color: darkblue;">
        ...
        <th align="center" style="color: white;" width="100">Uraian Penggunaan</th>
        <th align="center" style="color: white;" width="100">Kondisi Alat</th>
        <th align="center" style="color: white;" width="100">Nama</th>
    ...
    <?php
     include "koneksi.php";
     $i=1;
     $ambildata = mysqli_query($koneksi,"select * from alat_tokebi WHERE no_form LIKE '%AT%' ORDER by id DESC");
    ...
    if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
      while($tampil = mysqli_fetch_array($ambildata)){ // Ambil semua data dari hasil eksekusi $sql
        ...
        echo "<tr>";
                                ...
                                echo "<td align='center'>".$tampil["ur_pgn"]."</td>";
                                echo "<td align='center'>".$tampil["knds_alt"]."</td>";
...
$mpdf->WriteHTML($html);
$mpdf->Output('Data LOGBOOK PENGGUNAAN ALAT TOKEBI.pdf', 'I');
?>